...
此方法短期不会补充。这个方案很尴尬，如果你能时常拿到电脑去搞这个方案，为什么不直接用电脑玩《我的世界》呢？

但如果你成功拥有一个可以正常使用的欧版苹果手机或者平板、账号也是欧区、电话卡也是欧盟国家的、你也一直在用欧洲的网络（在中国国内几乎不可能），你确实可以尝试这个方案，直接从 App Store 搜 AltStore 就行了。
